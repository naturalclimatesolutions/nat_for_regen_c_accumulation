...
congo <- read.csv(paste(data_dir, 'Fig3_congo_cr_pars.csv', sep = "/"))
congo_pars <- list(A = 116.6176, K = 0.022315, C = 0.767582)
amazon <- read.csv(paste(data_dir, 'Fig3_amazon_cr_pars.csv', sep = "/"))
amazon_pars <- list(A = 121.0104, K = 0.01297, C = 0.671297)
borneo <- read.csv(paste(data_dir, 'Fig3_borneo_cr_pars.csv', sep = "/"))
